...
output "dns_manual_entries" {
  value = ["demo.openconceptlab.org", "api.demo.openconceptlab.org", "flower.demo.openconceptlab.org", "openmrs.demo.openconceptlab.org", "openmrs.staging.openconceptlab.org", "staging.openconceptlab.org", "api.staging.openconceptlab.org", "flower.staging.openconceptlab.org"]
}
